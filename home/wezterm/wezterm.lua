...
config.keys = {
...

	{
		key = "w",
		mods = "LEADER",
		action = act.ActivateKeyTable({ name = "window", one_shot = true, timeout_milliseconds = 1000 }),
	},
	{
		key = "b",
		mods = "LEADER",
		action = act.ActivateKeyTable({ name = "buffer", one_shot = true, timeout_milliseconds = 1000 }),
	},
	{
		key = "p",
		mods = "LEADER",
		action = act.ActivateKeyTable({ name = "project", one_shot = true, timeout_milliseconds = 1000 }),
	},
	{
		key = "t",
		mods = "LEADER",
		action = act.ActivateKeyTable({ name = "toggle", one_shot = true, timeout_milliseconds = 1000 }),
	},
	{
		key = "o",
		mods = "LEADER",
		action = act.ActivateKeyTable({ name = "open", one_shot = true, timeout_milliseconds = 1000 }),
	},
